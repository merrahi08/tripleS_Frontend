...
export default function LandingPage({ onLoginSuccess }) {
  ...
  const handleSendMessage = (e) => {
    ...
    setTimeout(() => {
      let botResponse =
        "C'est une excellente question ! Dans le cadre du programme Triple S, nous pouvons utiliser l'IA pour générer votre Lean Canvas ou vous mettre en relation avec un mentor marocain expert.";
      if (
        userInput.toLowerCase().includes("canvas") ||
        userInput.toLowerCase().includes("lean")
      ) {
        botResponse =
          "Le Lean Canvas est essentiel. Dans le plan Standard, notre assistant IA vous pose des questions guidées et remplit automatiquement vos segments de clientèle, canaux et flux de revenus !";
      } else if (
        userInput.toLowerCase().includes("financement") ||
        userInput.toLowerCase().includes("forsa")
      ) {
        botResponse =
          "Nous accompagnons nos membres Premium dans la préparation des dossiers pour Forsa, Tamwilcom et les banques partenaires.";
      }
      setChatMessages((prev) => [
        ...prev,
        { id: Date.now() + 1, sender: "sami", text: botResponse },
      ]);
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-brand-black text-white">
      ...
      <main className="flex-grow">
        ...
        <section className="spotlight-bg pt-20 pb-28 px-6 text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto flex flex-col items-center">
            ...
            <h1 className="text-6xl md:text-8xl font-bold text-white tracking-tight mb-4">
              TRIPLE{" "}
              <span className="text-brand-lightGold font-serif italic">S</span>
            </h1>
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl leading-relaxed mb-10">
              Transformez votre idée en projet concret grâce à l'intelligence
              artificielle et à l'accompagnement d'experts.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <a
                href="#solutions"
                className="w-full sm:w-auto border border-white/20 hover:border-white/40 hover:bg-white/5 text-white font-semibold px-8 py-4 rounded-xl transition-all text-base text-center"
              >
                Découvrir
              </a>
            </div>
        ...
        <section id="problem" className="py-24 px-6 bg-brand-black">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 text-left">
              <span className="text-xs font-bold text-brand-gold tracking-widest uppercase block mb-3">
                Le Problème
              </span>
              <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-4">
                Vous avez une{" "}
                <span className="text-brand-lightGold font-serif italic">
                  idée
                </span>
                , mais...
              </h2>
              <p className="text-gray-400 text-base md:text-lg max-w-2xl">
                TRIPLE S vous guide à chaque étape.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 transition-all duration-300 hover:border-white/10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Trop d'informations, aucune feuille de route claire.
                </p>
              </div>

              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 transition-all duration-300 hover:border-white/10">
                <div className="text-2xl mb-6">
                  <i className="fa-solid fa-money-bill-trend-up text-emerald-400"></i>
                </div>
                <h3 className="text-xl font-bold text-white mb-3 font-serif">
                  Vous cherchez un financement ?
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Forsa, Tamwilcom, banques — un labyrinthe sans guide.
                </p>
              </div>
              ...
              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 transition-all duration-300 hover:border-white/10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Personne pour vous épauler dans les moments clés.
                </p>
              </div>
            </div>
          </div>
        ...
        <section
          id="solutions"
          className="py-24 px-6 bg-brand-black border-t border-white/5"
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-white">
                Tout ce qu'il vous faut,{" "}
                <span className="text-brand-lightGold font-serif italic border-b border-brand-gold/30 pb-1">
                  au même endroit
                </span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-brand-darkGray border border-white/5 hover:border-brand-gold/30 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-brand-lightGold transition-colors">
                    Assistant IA
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    Réponses instantanées et recommandations personnalisées pour
                    avancer sans perdre de temps.
                  </p>
                </div>
                <ul className="space-y-2 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2 text-xs text-brand-lightGold">
                    <i className="fa-solid fa-circle text-[6px]"></i> Réponses
                    instantanées
                  </li>
                  <li className="flex items-center gap-2 text-xs text-brand-lightGold">
              ...
              <div className="bg-brand-darkGray border border-white/5 hover:border-brand-gold/30 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    Mentorat et conseils pratiques par des entrepreneurs et
                    experts du terrain marocain.
                  </p>
                </div>
                <ul className="space-y-2 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2 text-xs text-brand-lightGold">
                    <i className="fa-solid fa-circle text-[6px]"></i> Mentorat
                    direct
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-brand-darkGray border border-white/5 hover:border-brand-gold/30 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    Suivez vos objectifs et la progression de votre projet en
                    temps réel grâce à une roadmap claire.
                  </p>
                </div>
                <ul className="space-y-2 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2 text-xs text-brand-lightGold">
                    <i className="fa-solid fa-circle text-[6px]"></i> Suivi des
                    objectifs
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-brand-darkGray border border-white/5 hover:border-brand-gold/30 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between group">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed mb-6">
                    Orientation vers les bons programmes marocains : Forsa,
                    Tamwilcom, banques et VCs.
                  </p>
                </div>
                <ul className="space-y-2 border-t border-white/5 pt-4">
                  <li className="flex items-center gap-2 text-xs text-brand-lightGold">
                    <i className="fa-solid fa-circle text-[6px]"></i> Forsa &
                    Tamwilcom
                  </li>
                </ul>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 hover:border-brand-gold/20">
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed mb-8 italic">
                    "TRIPLE S m'a permis de structurer mon projet et de
                    décrocher un financement Forsa en moins de 2 mois."
                  </p>
                </div>
                <div className="flex items-center gap-4 border-t border-white/5 pt-4">
                  <div className="w-10 h-10 rounded-full bg-brand-lightGold text-brand-black font-bold flex items-center justify-center text-xs shrink-0">
                    YL
                  </div>
                  <div>
                    <h4 className="text-white font-bold text-sm">Yassine L.</h4>
                    <p className="text-gray-500 text-xs">
                      Fondateur, AgriTech Casa
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 hover:border-brand-gold/20">
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed mb-8 italic">
                    "L'assistant IA répond à mes questions à toute heure, et le
                    mentor m'a aidée à éviter de gros pièges."
                  </p>
                </div>
                <div className="flex items-center gap-4 border-t border-white/5 pt-4">
                  <div className="w-10 h-10 rounded-full bg-brand-lightGold text-brand-black font-bold flex items-center justify-center text-xs shrink-0">
              ...
              <div className="bg-brand-darkGray/40 border border-white/5 rounded-2xl p-8 flex flex-col justify-between transition-all duration-300 hover:border-brand-gold/20">
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed mb-8 italic">
                    "Enfin une plateforme marocaine qui comprend nos réalités.
                    Je recommande à 100%."
                  </p>
                </div>
                <div className="flex items-center gap-4 border-t border-white/5 pt-4">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <div className="flex items-center justify-center gap-4 mt-8">
                <span
                  className={`text-sm ${!isAnnual ? "text-brand-lightGold font-bold" : "text-gray-400"}`}
                >
                  Mensuel
                </span>
                <button
                  ...
                  className="w-12 h-6 rounded-full bg-brand-darkGray border border-brand-gold/30 p-1 flex items-center transition-all"
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-brand-gold transition-all ${isAnnual ? "translate-x-6" : "translate-x-0"}`}
                  ></div>
                </button>
                <span
                  className={`text-sm ${isAnnual ? "text-brand-lightGold font-bold" : "text-gray-400"}`}
                >
                  Annuel{" "}
                  <span className="bg-brand-gold/15 text-brand-lightGold text-[10px] font-bold px-2 py-0.5 rounded ml-1">
                    -20%
                  </span>
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
                ...
                <div>
                  ...
                  <ul className="space-y-4 mb-8 text-sm text-gray-300">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Contenu de base</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-500 mt-0.5">✓</span>
                      <span>Lean Canvas guidé</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-500 mt-0.5">✓</span>
                      <span>Communauté entrepreneurs</span>
                    </li>
                  </ul>
                </div>
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-white text-brand-black font-semibold hover:bg-gray-200 transition-all text-sm mt-auto"
                >
                  Commencer gratuitement
                </button>
              </div>
              ...
              <div className="bg-[#121212] border border-white/5 rounded-3xl p-8 flex flex-col justify-between hover:border-white/10 transition-all duration-300">
                <div>
                  ...
                  <ul className="space-y-4 mb-8 text-sm text-gray-300">
                    ...
                    <li className="flex items-start gap-3">
                      <span className="text-gray-500 mt-0.5">✓</span>
                      <span>Contenu digital complet</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-500 mt-0.5">✓</span>
                      <span>Outils & templates</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="text-gray-500 mt-0.5">✓</span>
                      <span>Tableau de bord projet</span>
                    </li>
                  </ul>
                </div>
                <button
              ...
              <div className="bg-[#121212] border border-brand-gold rounded-3xl p-8 flex flex-col justify-between shadow-2xl shadow-brand-gold/5 relative pt-12 transition-all duration-300">
                <div className="absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 bg-brand-gold text-brand-black font-semibold text-xs px-4 py-1.5 rounded-full flex items-center gap-1.5 whitespace-nowrap shadow-md">
                  <i className="fa-regular fa-star text-[11px]"></i>
                ...
                <div>
                  ...
                  <ul className="space-y-4 mb-8 text-sm text-gray-300">
                    <li className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-brand-gold/20 text-brand-lightGold flex items-center justify-center text-[10px] mt-0.5 shrink-0">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <span>Mentorat experts</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-brand-gold/20 text-brand-lightGold flex items-center justify-center text-[10px] mt-0.5 shrink-0">
                        <i className="fa-solid fa-check"></i>
                      </span>
                      <span>Consulting personnalisé</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-5 h-5 rounded-full bg-brand-gold/20 text-brand-lightGold flex items-center justify-center text-[10px] mt-0.5 shrink-0">
                        <i className="fa-solid fa-check"></i>
                      </span>
                      <span>Dossier financement</span>
                    </li>
                  </ul>
                </div>
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-brand-gold text-brand-black font-bold hover:bg-brand-hoverGold transition-all text-sm mt-auto shadow-lg shadow-brand-gold/10"
                >
                  Choisir Premium
                </button>
              </div>
      ...
      {/* ─── FOOTER ─── */}
      <footer
        className="border-t border-white/5 bg-[#424242b5]"
        style={{ borderTop: "5rem" }}
      >
        <div className="max-w-7xl mx-auto px-6 py-14">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                Transformez votre idée en projet concret grâce à l'intelligence
                artificielle, au mentorat et à l'accompagnement d'experts.
              </p>
              ...
              <div className="flex items-center gap-3 mt-6">
                <a
                  href="#"
                  className="w-10 h-10 rounded-lg bg-brand-darkGray border border-white/5
                       flex items-center justify-center text-gray-400
                       hover:text-brand-lightGold hover:border-brand-gold/30
                       transition-all"
                  aria-label="LinkedIn"
                >
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a
                    href="#problem"
                    className="text-gray-400 hover:text-brand-lightGold transition-colors"
                  >
                    Le Problème
                  </a>
                </li>
          ...
          {/* Bottom footer */}
          <div
            className="border-t border-white/5 mt-12 pt-6 flex flex-col md:flex-row
                    items-center justify-between gap-4"
          >
            <p className="text-gray-500 text-xs">
              © {new Date().getFullYear()} TRIPLE S. Tous droits réservés.
            </p>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        {isChatOpen ? (
          <div className="w-96 max-w-[calc(100vw-32px)] h-[500px] bg-brand-darkGray border border-brand-gold/30 rounded-2xl shadow-2xl flex flex-col justify-between overflow-hidden">
            ...
            <div className="flex-grow p-4 overflow-y-auto space-y-4">
              {chatMessages.map((msg) => (
                ...
                >
                  <div
                    className={`max-w-[80%] rounded-xl px-4 py-2 text-sm ${msg.sender === "user" ? "bg-brand-gold text-brand-black font-semibold" : "bg-brand-black text-gray-200"}`}
                  >
                    {msg.text}
                  </div>
                </div>
            ...
            <form
              ...
              className="p-4 bg-brand-black border-t border-white/5 flex gap-2"
            >
              <input
                type="text"
              ...
              <button
                type="submit"
                className="w-10 h-10 rounded-xl bg-brand-lightGold text-brand-black flex items-center justify-center hover:bg-brand-hoverGold transition-all"
              >
          ...
          <button
            ...
            className="w-14 h-14 rounded-full bg-brand-lightGold text-brand-black shadow-xl flex items-center justify-center hover:scale-105 transition-all text-xl"
          >
            ...
            {registerSuccess ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  {isLoginMode
                    ? "Bienvenue dans votre espace de travail, log in second.."
                    : "Vous etes inscrit ,log in seconde..."}
                </p>
              </div>
            ) : (
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-6">
                  {isLoginMode
                    ...
                    : `Rejoindre Triple S (${selectedTier})`}
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {!isLoginMode && (
                    <textarea
                      rows="3"
                      placeholder="Votre idée de projet..."
                      className="w-full bg-brand-black border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-brand-gold/50"
                      value={formData.idea}
                      onChange={(e) =>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3.5 bg-brand-lightGold text-brand-black rounded-xl font-bold hover:bg-brand-hoverGold transition-all text-sm"
                  >
            ...
            {expertRegisterSuccess ? (
              ...
              <div>
                <div className="mb-6">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Create your mentor profile and help Moroccan entrepreneurs
                    structure and grow their projects.
                  </p>
                </div>
